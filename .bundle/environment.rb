...
module Bundler
  ENV_LOADED   = true
  LOCKED_BY    = '0.9.26'
  FINGERPRINT  = "b7734d60076317f255477e7e86206d7fe806ed38"
  HOME         = '/Users/jeff/.bundle/ruby/1.8/bundler'
  AUTOREQUIRES = {:default=>[["rake", false], ["jeweler", false], ["rspec", false]]}
  SPECS        = [
        ...
        {:load_paths=>["/Users/jeff/.bundle/ruby/1.8/gems/gemcutter-0.6.1/lib"], :loaded_from=>"/Users/jeff/.bundle/ruby/1.8/specifications/gemcutter-0.6.1.gemspec", :name=>"gemcutter"},
        {:load_paths=>["/opt/local/lib/ruby/gems/1.8/gems/git-1.2.5/lib"], :loaded_from=>"/opt/local/lib/ruby/gems/1.8/specifications/git-1.2.5.gemspec", :name=>"git"},
        {:load_paths=>["/Users/jeff/.bundle/ruby/1.8/gems/json_pure-1.4.6/lib"], :loaded_from=>"/Users/jeff/.bundle/ruby/1.8/specifications/json_pure-1.4.6.gemspec", :name=>"json_pure"},
        {:load_paths=>["/Users/jeff/.bundle/ruby/1.8/gems/rubyforge-2.0.4/lib"], :loaded_from=>"/Users/jeff/.bundle/ruby/1.8/specifications/rubyforge-2.0.4.gemspec", :name=>"rubyforge"},
        {:load_paths=>["/opt/local/lib/ruby/gems/1.8/gems/jeweler-1.4.0/lib"], :loaded_from=>"/opt/local/lib/ruby/gems/1.8/specifications/jeweler-1.4.0.gemspec", :name=>"jeweler"},
